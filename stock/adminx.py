...
xadmin.site.site_header = '骨鱼'
xadmin.site.site_title = '骨鱼'
xadmin.site.register(MUser, MUserAdmin)
xadmin.site.register(MStock, MStockAdmin)
xadmin.site.register(MStock_His, HisMStockAdmin)